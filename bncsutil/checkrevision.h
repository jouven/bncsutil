 ...
 * failure.
 */
extern int extractMPQNumber(const char* mpqName);

/**
 * Runs CheckRevision.
 * First file must be the executable file.
 */
extern int checkRevision(
 ...
 * necessary.
 */
extern int getExeInfo(const char* file_name,
                     char* exe_info,
