...
int kd_create(const char* cdkey, int keyLength) {
    unsigned int i;
    CDKeyDecoder** d;
...
/*
int kd_create(char* cdkey, int keyLength) {
    if (!kd_lock_decoders()) return -1;
    CDKeyDecoder* d;
    unsigned int i;
...
int kd_longVal2(int decoder, char* out) {
    CDKeyDecoder* d;
    int value;
...
int kd_calculateHash(int decoder, uint32_t clientToken,
...
int kd_getHash(int decoder, char* out) {
    CDKeyDecoder* d;
    int value;
