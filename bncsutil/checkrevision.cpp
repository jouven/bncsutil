...
long get_mpq_seed(int mpq_number)
{
...
long set_mpq_seed(int mpq_number, long new_seed)
{
    long ret;
...
int checkRevision(const char* formula, const char* files[], int numFiles,
...
int checkRevisionFlat(const char* valueString, const char* file1,
...
int getExeInfo(const char* file_name, char* exe_info,
