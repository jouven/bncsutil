...
cm_pe_t cm_pe_load(const char* filename)
{
    cm_pe_t pe;
...
cm_pe_section_t* cm_pe_get_section(cm_pe_t pe, const char* name) {
    unsigned int i;
    cm_pe_section_t* s;
...
cm_pe_resdir_t* cm_pe_load_resources(cm_pe_t pe)
{
...
int cm_pe_unload_resources(cm_pe_resdir_t* root)
{
    cm_pe_resdir_t* dir;
    cm_stack_t stack;
...
int cm_pe_fixed_version(cm_pe_t pe, cm_pe_res_t* res,
                              cm_pe_version_t* ver)
{
    // find ".rsrc" section
